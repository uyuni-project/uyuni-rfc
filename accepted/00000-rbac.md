...
This proposal specifically addresses level 2, authorization.
Level 1 is managed through the authentication filter, and level 3 is handled within each feature implementation, thus falling outside the scope of this RFC.
